    ...
    for (let i = 0; i < cartArr.length; i++) {
      ...
      div.innerHTML += `
          <div class="p-[2rem] border-black-200 border-solid border-2 rounded-lg drop-shadow-2xl mt-5">
                  <p><span class="font-bold text-lg">brand:</span> ${
                    cartArr[i].brand
                  }</p>
                  <p><span class="font-bold text-lg">Model:</span> ${
                    cartArr[i].model
                  }</p>
                  <p><span class="font-bold text-lg">Quantity:</span> ${
                    cartArr[i].quantity
                  }</p>
                  <p><span class="font-bold text-lg">Price:</span> ${
                    cartArr[i].price
                  }</p>
                  <p><span class="font-bold text-lg">Total Price:</span> ${
                    cartArr[i].price * cartArr[i].quantity
                  }</p>
